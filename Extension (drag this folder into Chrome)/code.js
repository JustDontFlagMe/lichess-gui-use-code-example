var innerContent = function () {
  setTimeout(function () {
    ...
    if (
      document.getElementsByClassName('signin button button-empty')[0] !=
      undefined
    ) {
      var anonc = document.getElementsByClassName(
    ...
    if (doit == 1) {
      ...
      var KeyUp = function (event) {
        ...
        if (key == biK) {
          for (
            var ee = 0;
            ee < document.getElementsByClassName(mycolor + ' bishop').length;
            ee++
          ) {
            document.getElementsByClassName(mycolor + ' bishop')[
              ee
        ...
        if (key == qK) {
          if (
            document.getElementsByClassName(mycolor + ' queen')[0] != undefined
          ) {
        ...
        if (key == roL) {
          if (
            document.getElementsByClassName(mycolor + ' rook')[nn0] != undefined
          ) {
            document.getElementsByClassName(mycolor + ' rook')[
              nn0
            ].style.backgroundColor = '';
          }
        }
        if (key == roR) {
          if (
            document.getElementsByClassName(mycolor + ' rook')[nn1] != undefined
          ) {
            document.getElementsByClassName(mycolor + ' rook')[
              nn1
            ].style.backgroundColor = '';
        ...
        if (key == knL) {
          if (
            document.getElementsByClassName(mycolor + ' knight')[nn0] !=
            undefined
          ) {
            document.getElementsByClassName(mycolor + ' knight')[
              nn0
            ].style.backgroundColor = '';
          }
        }
        if (key == knR) {
          if (
            document.getElementsByClassName(mycolor + ' knight')[nn1] !=
            undefined
          ) {
            document.getElementsByClassName(mycolor + ' knight')[
              nn1
        ...
        if (key == pLK || key == pFK || key == pRK) {
          for (
            var e1 = 0;
            e1 < document.getElementsByClassName(mycolor + ' pawn').length;
            e1++
          ) {
            document.getElementsByClassName(mycolor + ' pawn')[
              e1
            ].style.backgroundColor = '';
          }
        }
      ...
      var KeyDown = function (event) {
        ...
        if (key == rmtch) {
          if (
            document.getElementsByClassName('fbt rematch white')[0] != undefined
          ) {
          ...
          for (var y = 0; y < numK; y++) {
            if (keysT[0] == pFK) {
              ...
              for (var pn = 0; pn < pawnN; pn++) {
                ...
                pawnX = Math.ceil(
                  (pawnrect.left + sqsize / 2 - rect.left) / sqsize
                );
                pawnY =
                  9 -
                  Math.ceil((pawnrect.top + sqsize / 2 - rect.top) / sqsize);
                if (pawnX == horiz0 && pawnY == vertic0 - 1) {
                  toX = horiz0 * sqsize + rect.left - sqsize / 2;
                  toY = (9 - vertic0) * sqsize + rect.top - sqsize / 2;
                  tts(
                    pawnrect.left + sqsize / 2,
                    pawnrect.top + sqsize / 2,
                    toX,
                    toY
                  );
                  p2 = 0;
            ...
            if (keysT[0] == pLK) {
              ...
              for (var pnL = 0; pnL < pawnN; pnL++) {
                ...
                pawnLX = Math.ceil(
                  (pawnLrect.left + sqsize / 2 - rect.left) / sqsize
                );
                pawnLY =
                  9 -
                  Math.ceil((pawnLrect.top + sqsize / 2 - rect.top) / sqsize);
                if (pawnLX == horiz0 + 1 && pawnLY == vertic0 - 1) {
                  toX = horiz0 * sqsize + rect.left - sqsize / 2;
                  toY = (9 - vertic0) * sqsize + rect.top - sqsize / 2;
                  tts(
                    pawnLrect.left + sqsize / 2,
                    pawnLrect.top + sqsize / 2,
                    toX,
                    toY
                  );
                  break;
            ...
            if (keysT[0] == pRK) {
              ...
              for (var pnR = 0; pnR < pawnN; pnR++) {
                ...
                pawnRX = Math.ceil(
                  (pawnRrect.left + sqsize / 2 - rect.left) / sqsize
                );
                pawnRY =
                  9 -
                  Math.ceil((pawnRrect.top + sqsize / 2 - rect.top) / sqsize);
                if (pawnRX == horiz0 - 1 && pawnRY == vertic0 - 1) {
                  toX = horiz0 * sqsize + rect.left - sqsize / 2;
                  toY = (9 - vertic0) * sqsize + rect.top - sqsize / 2;
                  tts(
                    pawnRrect.left + sqsize / 2,
                    pawnRrect.top + sqsize / 2,
                    toX,
                    toY
                  );
                  break;
            ...
            if (keysT[0] == kingK) {
              ...
              kingX = Math.ceil(
                (kingrect.left + sqsize / 2 - rect.left) / sqsize
              );
              kingY =
                9 - Math.ceil((kingrect.top + sqsize / 2 - rect.top) / sqsize);
              if (
                (kingX == horiz0 && kingY == vertic0 - 1) ||
                (kingX == horiz0 && kingY == vertic0 + 1) ||
                (kingX == horiz0 - 1 && kingY == vertic0) ||
                (kingX == horiz0 + 1 && kingY == vertic0) ||
                (kingX == horiz0 - 1 && kingY == vertic0 - 1) ||
                (kingX == horiz0 - 1 && kingY == vertic0 + 1) ||
                (kingX == horiz0 + 1 && kingY == vertic0 - 1) ||
                (kingX == horiz0 + 1 && kingY == vertic0 + 1) ||
                (kingX == horiz0 + 2 && kingY == vertic0) ||
                (kingX == horiz0 - 2 && kingY == vertic0)
              ) {
                toX = horiz0 * sqsize + rect.left - sqsize / 2;
                toY = (9 - vertic0) * sqsize + rect.top - sqsize / 2;
                tts(
                  kingrect.left + sqsize / 2,
                  kingrect.top + sqsize / 2,
                  toX,
                  toY
                );
              }
            ...
            if (keysT[0] == qK) {
              ...
              for (var qR = 0; qR < queenN; qR++) {
                ...
                queenX = Math.ceil(
                  (queenrect.left + sqsize / 2 - rect.left) / sqsize
                );
                queenY =
                  9 -
                  Math.ceil((queenrect.top + sqsize / 2 - rect.top) / sqsize);
                if (
                  (queenX == horiz0 ||
                    queenY == vertic0 ||
                    Math.abs(horiz0 - queenX) == Math.abs(vertic0 - queenY)) &&
                  !(queenX == horiz0 && queenY == vertic0)
                ) {
                  toX = horiz0 * sqsize + rect.left - sqsize / 2;
                  toY = (9 - vertic0) * sqsize + rect.top - sqsize / 2;
                  tts(
                    queenrect.left + sqsize / 2,
                    queenrect.top + sqsize / 2,
                    toX,
                    toY
                  );
                  break;
            ...
            if (keysT[0] == biK) {
              ...
              for (var bR = 0; bR < bishN; bR++) {
                ...
                bishX = Math.ceil(
                  (bishrect.left + sqsize / 2 - rect.left) / sqsize
                );
                bishY =
                  9 -
                  Math.ceil((bishrect.top + sqsize / 2 - rect.top) / sqsize);
                if (
                  Math.abs(horiz0 - bishX) == Math.abs(vertic0 - bishY) &&
                  !(bishX == horiz0 && bishY == vertic0)
                ) {
                  toX = horiz0 * sqsize + rect.left - sqsize / 2;
                  toY = (9 - vertic0) * sqsize + rect.top - sqsize / 2;
                  tts(
                    bishrect.left + sqsize / 2,
                    bishrect.top + sqsize / 2,
                    toX,
                    toY
                  );
                  break;
            ...
            if (keysT[0] == roL) {
              if (mycolor == 'white') {
                ...
                for (var rR = 0; rR < rookN; rR++) {
                  ...
                  rookX = Math.ceil(
                    (rookrect.left + sqsize / 2 - rect.left) / sqsize
                  );
                  rookY =
                    9 -
                    Math.ceil((rookrect.top + sqsize / 2 - rect.top) / sqsize);
                  if (
                    (rookX == horiz0 || rookY == vertic0) &&
                    !(rookX == horiz0 && rookY == vertic0)
                  ) {
                    if (rR == 0 && turnC == 1 && rookN > 1) {
                      rooktrect = rookC[1].getBoundingClientRect();
                      rooktX = Math.ceil(
                        (rooktrect.left + sqsize / 2 - rect.left) / sqsize
                      );
                      rooktY =
                        9 -
                        Math.ceil(
                          (rooktrect.top + sqsize / 2 - rect.top) / sqsize
                        );
                      if (
                        (rooktX == rookX &&
                          rookX == horiz0 &&
                        ...
                        toY = (9 - vertic0) * sqsize + rect.top - sqsize / 2;
                        tts(
                          rooktrect.left + sqsize / 2,
                          rooktrect.top + sqsize / 2,
                          toX,
                          toY
                        );
                        break;
                    ...
                    toY = (9 - vertic0) * sqsize + rect.top - sqsize / 2;
                    tts(
                      rookrect.left + sqsize / 2,
                      rookrect.top + sqsize / 2,
                      toX,
                      toY
                    );
                    break;
            ...
            if (keysT[0] == knL) {
              if (mycolor == 'white') {
                ...
                for (var kR = 0; kR < knightN; kR++) {
                  ...
                  knightX = Math.ceil(
                    (knightrect.left + sqsize / 2 - rect.left) / sqsize
                  );
                  knightY =
                    9 -
                    Math.ceil(
                      (knightrect.top + sqsize / 2 - rect.top) / sqsize
                    );
                  if (
                    (knightX == horiz0 + 1 && knightY == vertic0 - 2) ||
                    (knightX == horiz0 + 2 && knightY == vertic0 - 1) ||
                    (knightX == horiz0 + 2 && knightY == vertic0 + 1) ||
                    (knightX == horiz0 + 1 && knightY == vertic0 + 2) ||
                    (knightX == horiz0 - 1 && knightY == vertic0 + 2) ||
                    (knightX == horiz0 - 2 && knightY == vertic0 + 1) ||
                    ...
                    toY = (9 - vertic0) * sqsize + rect.top - sqsize / 2;
                    tts(
                      knightrect.left + sqsize / 2,
                      knightrect.top + sqsize / 2,
                      toX,
                      toY
                    );
                    break;
      ...
      var get_color = function () {
        ...
        if (wclock) {
          mycolor = wclock.className.includes('clock_bottom')
            ? 'white'
            : 'black';
        }
        return mycolor;
      ...
      var AssignKeys = function (idK) {
        ...
        if (oneKey() == true) {
          ...
          if (ch1skeys == 1) {
            document.getElementsByTagName('summary')[0].innerText =
              'Hover the cursor over a destination square and press a corresponding key';
      ...
      for (var i$1 = 0; i$1 < 5; i$1++) {
        Object.defineProperty(notationObject, plyArray[i$1], {
          value: fenArray[i$1],
          writable: fenArray[i$1] === 0,
          enumerable: true,
        });
      }
      ...
      if (oneKey() == true) {
        document.getElementsByTagName('summary')[0].innerText =
          'Please make sure you use different keys for each piece';
      ...
      if (mycolor == 'white') {
        ...
        if (
          document.getElementsByClassName(mycolor + ' knight')[nn1] != undefined
        ) {
          document.getElementsByClassName(mycolor + ' knight')[
            nn1
          ].style.backgroundImage =
            ...
            if (oncebeep == 1) {
              ...
              window.setTimeout(function () {
                ...
                for (var ppp = 0; ppp < mypieces.length; ++ppp) {
                  if (
                    mypieces[ppp].className.includes(mycolor) &&
                    !mypieces[ppp].className.includes('ghost')
                  ) {
                    pcc = mypieces[ppp].getBoundingClientRect();
                    pccn =
                      (1 + Math.round((pcc.left - rect.left) / sqsize)) * 10 +
                      (8 - Math.round((pcc.top - rect.top) / sqsize));
                    st.push(pccn);
                  }
                }
                makemoves();
